...
A macOS application for watermarking documents and maintaining control over your important files (e.g. passport, ID sent for an online application, confidential PDF files ...)
