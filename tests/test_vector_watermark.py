...
def test_vector_watermark_text_added_to_page(test_pdf):
    ...
    params = WatermarkParams(text="WATERMARK", opacity=30, font_size=36, spacing=150, color="White")
...
def test_vector_watermark_respects_opacity(test_pdf):
    ...
    params = WatermarkParams(text="TEST", opacity=30, font_size=36, spacing=150, color="Black")
    apply_vector_watermark_to_pdf(doc, params)
    ...
    assert b'TEST' in content_bytes or b'Tj' in content_bytes or b'TJ' in content_bytes, \
        "Page content should contain text drawing operators"
...
def test_vector_watermark_respects_font_size(test_pdf):
    ...
    params = WatermarkParams(text="SIZE", opacity=50, font_size=48, spacing=200, color="Black")
    apply_vector_watermark_to_pdf(doc, params)
...
def test_vector_watermark_respects_spacing(test_pdf):
    ...
    params_tight = WatermarkParams(text="SPACE", opacity=50, font_size=36, spacing=100, color="Black")
    params_wide = WatermarkParams(text="SPACE", opacity=50, font_size=36, spacing=300, color="Black")

    apply_vector_watermark_to_pdf(doc1, params_tight)
    apply_vector_watermark_to_pdf(doc2, params_wide)
...
def test_vector_watermark_respects_color_white(test_pdf):
    ...
    params = WatermarkParams(text="WHITE", opacity=50, font_size=36, spacing=150, color="White")
    apply_vector_watermark_to_pdf(doc, params)
...
def test_vector_watermark_respects_color_black(test_pdf):
    ...
    params = WatermarkParams(text="BLACK", opacity=50, font_size=36, spacing=150, color="Black")
    apply_vector_watermark_to_pdf(doc, params)
...
def test_vector_watermark_respects_color_gray(test_pdf):
    ...
    params = WatermarkParams(text="GRAY", opacity=50, font_size=36, spacing=150, color="Gray")
    apply_vector_watermark_to_pdf(doc, params)
...
def test_vector_watermark_diagonal_tiling_pattern(test_pdf):
    ...
    assert len(content) > 0
    assert b'cm' in content or b'Tm' in content, \
        "Transformation matrix should be present for rotation"
...
def test_vector_watermark_multipage(multipage_pdf):
    ...
    params = WatermarkParams(text="MULTIPAGE", opacity=40, font_size=36, spacing=150, color="Black")
    apply_vector_watermark_to_pdf(doc, params)
...
def test_vector_watermark_overlay_layer(test_pdf):
    ...
    params = WatermarkParams(text="OVERLAY", opacity=50, font_size=48, spacing=200, color="Black")
    apply_vector_watermark_to_pdf(doc, params)
